...
const styles = StyleSheet.create({
  ...
  avatar: { width: 120, height: 120, borderRadius: 60, borderWidth: 2, borderColor: Colors.red },
  avatarPlaceholder: {
    width: 120, height: 120, borderRadius: 60,
    backgroundColor: Colors.bgCard, borderWidth: 2, borderColor: Colors.red,
    alignItems: 'center', justifyContent: 'center',
  },
  avatarPlaceholderText: { fontSize: 44, fontWeight: '900', fontStyle: 'italic', color: Colors.red },
  avatarEditBadge: {
    position: 'absolute', bottom: 2, right: 2,
    width: 28, height: 28, borderRadius: 14,
    backgroundColor: Colors.red, alignItems: 'center', justifyContent: 'center',
  },
  avatarEditText: { fontSize: 13, color: '#fff', fontWeight: '900' },
  profileUsername: { fontSize: 16, fontWeight: '900', fontStyle: 'italic', color: Colors.textPrimary, letterSpacing: 1 },
